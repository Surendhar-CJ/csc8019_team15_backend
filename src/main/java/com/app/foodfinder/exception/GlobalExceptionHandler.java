...
public final class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handlingNotFoundException(NotFoundException notFoundException)
    {
        ErrorResponse errorResponse = new ErrorResponse(HttpStatus.NOT_FOUND.value(), notFoundException.getMessage(), LocalTime.now());
